...
#{ printf '\ttaxonomy\t\t\n'; cat 
#assign_gg_taxa/rumen.adaptation.otus2_tax_assignments.sort.txt ; }  > assign_gg_taxa/rumen.adaptation.otus2_tax_assignments.sort.label.txt
...
Align the sequences using the SILVA reference within mothur and view the alignment summary. Note that this step will take quite a bit of RAM and hard drive space (I ran it on a machine 8GB RAM fine):
```{r, engine='bash'}
