...
```{r, engine='bash', results='hide'}
wget https://github.com/chrisLanderson/rumen_adaptation/blob/master/usearch_python_scripts/uc2otutab.py
wget https://github.com/chrisLanderson/rumen_adaptation/blob/master/usearch_python_scripts/fasta_number.py
wget https://github.com/chrisLanderson/rumen_adaptation/blob/master/gold.fasta.gz
...
fasta_number.py usearch_results/rumen.adaptation.otus1.nonchimera.fasta > usearch_results/rumen.adaptation.otus2.fasta
...
uc2otutab.py usearch_results/rumen.adaptation.otu_map.uc > usearch_results/rumen.adaptation.otu_table.txt
