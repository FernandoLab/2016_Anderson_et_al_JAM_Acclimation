...
tiff("figures/alpha_diversity.tiff", units='in', height=12, width=12, res=300)
multiplot(rare_otu_plot, rare_chao1_plot, alpha_otu_plot, alpha_chao1_plot, cols=2)
dev.off()
```

<div style="text-align:center" markdown="1">
![ramp_venn](figures/alpha_diversity.tiff)
</div>
...
tiff("figures/corn_venn.tiff", units='in', height=6, width=6, res=300)
...
![ramp_venn](figures/corn_venn.tiff)
...
tiff("figures/ramp_venn.tiff", units='in', height=6, width=6, res=300)
ramp_venn <- venn(ramp_boolean_df)
dev.off()
```

<div style="text-align:center" markdown="1">
![ramp_venn](figures/ramp_venn.tiff)
</div>
...
#![otu_heatmap](figures/otu_heatmap.pdf)