...
pdf("figures/alpha_diversity.pdf", height=12, weight=12)
multiplot(rare_otu_plot, rare_chao1_plot, alpha_otu_plot, alpha_chao1_plot, cols=2)
dev.off()
```

<img src="figures/alpha_diversity.pdf" height="400px" width="300px" />
...
<img src="figures/corn_venn.pdf" height="400px" width="300px" />
...
<img src="figures/ramp_venn.pdf" height="400px" width="300px" />
