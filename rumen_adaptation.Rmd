...
png("figures/alpha_diversity.png", units='in', height=12, width=12, res=300)
multiplot(rare_otu_plot, rare_chao1_plot, alpha_otu_plot, alpha_chao1_plot, cols=2)
dev.off()

pdf("figures/alpha_diversity.pdf", height=12, width=12, res=300)
multiplot(rare_otu_plot, rare_chao1_plot, alpha_otu_plot, alpha_chao1_plot, cols=2)
dev.off()
```

<div style="text-align:center" markdown="1">
![ramp_venn](figures/alpha_diversity.png)
</div>
...
png("figures/corn_venn.png", units='in', height=6, width=6, res=300)
corn_venn <- venn(corn_boolean_df)
dev.off()

pdf("figures/corn_venn.pdf", height=6, width=6)
corn_venn <- venn(corn_boolean_df)
dev.off()
```

<div style="text-align:center" markdown="1">
![ramp_venn](figures/corn_venn.png)
</div>
...
png("figures/ramp_venn.png", units='in', height=6, width=6, res=300)
ramp_venn <- venn(ramp_boolean_df)
dev.off()

pdf("figures/ramp_venn.pdf", height=6, width=6)
ramp_venn <- venn(ramp_boolean_df)
dev.off()
```

<div style="text-align:center" markdown="1">
![ramp_venn](figures/ramp_venn.png)
</div>
...
#otu_table <- read.table("rumen.adaptation.otu_table.tax.final.biom", header=TRUE, sep="\t")

#otu_table <- read_biom("rumen.adaptation.otu_table.tax.final.biom")
