...
deps = c("knitr", "ggplot2", "vegan", "matrixStats", "grid", "reshape", "gplots", "biom", "Heatplus", "RColorBrewer");
...
```{r, engine='bash', results='hide'}
https://github.com/chrisLanderson/rumen_adaptation/blob/master/usearch_python_scripts/uc2otutab.py
https://github.com/chrisLanderson/rumen_adaptation/blob/master/usearch_python_scripts/fasta_number.py
