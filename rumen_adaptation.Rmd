...
png("alpha_diversity.png", units='in', height=12, width=12, res=300)
...
png("otu_heatmap.png", units='in', height=12, width=12, res=300)
heatmap.2(as.matrix(otu_table_rel2), Rowv = as.dendrogram(row.clus), Colv = as.dendrogram(col.clus), col = scalewhiteblack, margins = c(2, 6), trace = "none", density.info = "none", labCol="", xlab = "OTUs", ylab = "Samples", main = "", lhei = c(2, 8))
dev.off()
```

<div style="text-align:center" markdown="1">
![ramp_venn](otu_heatmap.png)
</div>
...
pdf("unweighted_pc_distance.pdf", height=4, width=4)
multiplot(corn_pc_plot, ramp_pc_plot, corn_distance, ramp_distance, cols=2)
dev.off()

png("unweighted_pc_distance.png", height=4, width=4, units='in', res=300)
multiplot(corn_pc_plot, ramp_pc_plot, corn_distance, ramp_distance, cols=2)
dev.off()
```

<div style="text-align:center" markdown="1">
![unweighted_distance](unweighted_pc_distance.png)
</div>
