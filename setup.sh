...
anaconda/bin/conda create -n rumenEnv python pip numpy matplotlib=1.4.3 scipy pandas cython mock nose
...
wget https://raw.githubusercontent.com/FernandoLab/2016_Anderson_et_al_JAM_Acclimation/master/rumen_acclimation.Rmd
