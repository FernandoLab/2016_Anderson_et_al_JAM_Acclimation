...
```{r, engine='bash'}
biom convert --table-type "OTU table" -i rumen.adaptation.otu_table.tax.final.biom -o rumen.adaptation.otu_table.tax.final.txt --process-obs-metadata taxonomy --to-tsv
