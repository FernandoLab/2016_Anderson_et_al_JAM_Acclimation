---
title: "Acclimation of the rumen microbiota during a finishing study"
...
wget https://github.com/FernandoLab/2016_Anderson_et_al_JAM_Acclimation/raw/master/rumen.acclimation.tar.gz
...
wget https://raw.githubusercontent.com/FernandoLab/2016_Anderson_et_al_JAM_Acclimation/master/mapping.txt
  
wget https://raw.githubusercontent.com/FernandoLab/2016_Anderson_et_al_JAM_Acclimation/master/qiime_parameters_working.txt
...
```{r, engine='bash', results='hide'}
wget https://raw.githubusercontent.com/FernandoLab/2016_Anderson_et_al_JAM_Acclimation/master/qiime_to_usearch.pl
...
```{r, engine='bash', results='hide'}
svn export https://github.com/FernandoLab/2016_Anderson_et_al_JAM_Acclimation/trunk/usearch_python_scripts --non-interactive --trust-server-cert
chmod -R 775 usearch_python_scripts
wget https://github.com/FernandoLab/2016_Anderson_et_al_JAM_Acclimation/raw/master/gold.fasta.gz
...
geom_pointrange(position=pd, size=0.3) +
...
```{r, engine='bash'}
wget https://raw.githubusercontent.com/FernandoLab/2016_Anderson_et_al_JAM_Acclimation/master/treatment_distances.pl
...
c1c1_c1c2_test
lapply(c1c1_c1c2_test$p.value, write, "corn_unweighted_c1c1_c1c2_wilcox.txt", append=TRUE)

c1c2_c1c3_test <- wilcox.test(corn_unweighted_pairs$C1_C2$Distance, corn_unweighted_pairs$C1_C3$Distance)
c1c2_c1c3_test
lapply(c1c2_c1c3_test$p.value, write, "corn_unweighted_c1c2_c1c3_wilcox.txt", append=TRUE)

c1c3_c1c4_test <- wilcox.test(corn_unweighted_pairs$C1_C3$Distance, corn_unweighted_pairs$C1_C4$Distance)
c1c3_c1c4_test
lapply(c1c3_c1c4_test$p.value, write, "corn_unweighted_c1c3_c1c4_wilcox.txt", append=TRUE)

c1c4_c1cf_test <- wilcox.test(corn_unweighted_pairs$C1_C4$Distance, corn_unweighted_pairs$C1_CF$Distance)
c1c4_c1cf_test
lapply(c1c4_c1cf_test$p.value, write, "corn_unweighted_c1c4_c1cf_wilcox.txt", append=TRUE)
...
r1r1_r1r2_test
lapply(r1r1_r1r2_test$p.value, write, "ramp_unweighted_r1r1_r1r2_wilcox.txt", append=TRUE)

r1r2_r1r3_test <- wilcox.test(ramp_unweighted_pairs$R1_R2$Distance, ramp_unweighted_pairs$R1_R3$Distance)
r1r2_r1r3_test
lapply(r1r2_r1r3_test$p.value, write, "ramp_unweighted_r1r2_r1r3_wilcox.txt", append=TRUE)

r1r3_r1r4_test <- wilcox.test(ramp_unweighted_pairs$R1_R3$Distance, ramp_unweighted_pairs$R1_R4$Distance)
r1r3_r1r4_test
lapply(r1r3_r1r4_test$p.value, write, "ramp_unweighted_r1r3_r1r4_wilcox.txt", append=TRUE)

r1r4_r1rf_test <- wilcox.test(ramp_unweighted_pairs$R1_R4$Distance, ramp_unweighted_pairs$R1_RF$Distance)
r1r4_r1rf_test
lapply(r1r4_r1rf_test$p.value, write, "ramp_unweighted_r1r4_r1rf_wilcox.txt", append=TRUE)
```
...
```{r}
library(spaa)
share_otu <- read.table("collapse_samples_shared_otus.txt", sep="\t", row.names=1, header=TRUE)
...
shape_all <- c("R1" = 15, "R2" = 16, "R3" = 17, "R4" = 18, "RF" = 8, "C1" = 15, "C2" = 16, "C3" = 17, "C4" = 18, "CF" = 8)
color_all <- c("R1" = "red", "R2" = "red", "R3" = "red", "R4" = "red", "RF" = "red", "C1" = "blue", "C2" = "blue", "C3" = "blue", "C4" = "blue", "CF" = "blue")
total_pc_plot <- ggplot(total_pc_map, aes(PC1, PC2)) +
geom_point(aes(size=4, color = factor(Treatment), shape = factor(Treatment))) +    xlab("PC1 (21.1%)") +
ylab("PC2 (10.0%)") +
guides(size=FALSE) + 
scale_shape_manual(name = "", values = shape_all) +
scale_colour_manual(name = "", values = color_all) +
labs(fill="")
